...
func (m *MockAuthService) Login(ctx *gin.Context, req apiModel.Login) (apiModel.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthService) Register(ctx *gin.Context, req apiModel.Register) (string, error) {
	m.ctrl.T.Helper()
